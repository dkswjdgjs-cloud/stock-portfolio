...
export default function MobilePage() {
  ...
  const S: Record<string, React.CSSProperties> = {
    wrap: { height: '100dvh', display: 'flex', flexDirection: 'column', background: '#f3f4f6', fontFamily: '-apple-system, BlinkMacSystemFont, sans-serif', paddingTop: 'env(safe-area-inset-top)', paddingBottom: 'env(safe-area-inset-bottom)' },
    header: { background: '#1e2433', padding: '12px 18px 0', flexShrink: 0 },
