      ...
      <div style={cardStyle}>
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 10 }}>
          ...
          <select value={mode} onChange={e => setMode(e.target.value as SettlementMode)}
            style={{ fontSize: 12, border: D ? 'none' : '0.5px solid #e5e7eb', borderRadius: 7, padding: '4px 8px', color: D ? '#f1f5f9' : '#374151', background: D ? '#000000' : '#f9fafb', outline: 'none' }}>
...
export default function MobilePage() {
  ...
  const S: Record<string, React.CSSProperties> = {
    wrap: { height: '100dvh', display: 'flex', flexDirection: 'column', background: D ? '#000000' : '#f3f4f6', fontFamily: '-apple-system, BlinkMacSystemFont, sans-serif', overscrollBehavior: 'none', overflow: 'hidden' },
    header: { background: D ? '#000000' : 'white', padding: '12px 18px 0', paddingTop: 'calc(env(safe-area-inset-top) + 12px)', flexShrink: 0, borderBottom: D ? '0.5px solid #000000' : 'none' },
    liveBox: { display: 'flex', alignItems: 'center', gap: 4, background: D ? '#000000' : '#f3f4f6', borderRadius: 20, padding: '3px 8px' },
          ...
          <>
            ...
            <div style={{ padding: '11px 16px', display: 'flex', justifyContent: 'space-between', alignItems: 'center', borderBottom: D ? 'none' : '0.5px solid #f3f4f6', background: D ? '#000000' : 'white' }}>
              ...
              <select value={accountFilter} onChange={e => handleAccountFilter(e.target.value)}
                style={{ fontSize: 14, border: D ? '0.5px solid #000000' : '0.5px solid #e5e7eb', borderRadius: 20, padding: '6px 14px', color: D ? '#f1f5f9' : '#111827', background: D ? '#000000' : 'white', outline: 'none', textAlign: 'center' }}>
            ...
            <div>
              ...
              {/* 현금성 자산 */}
              <div style={{ ...S.srow, background: D ? '#000000' : '#f9fafb' }}>
            ...
            <div style={S.card}>
              ...
              <div style={{ display: 'flex', justifyContent: 'center', marginBottom: 14 }}>
                <div style={{ width: 230, height: 230, borderRadius: '50%', background: makeConic(pieData), display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                  <div style={{ width: 115, height: 115, background: D ? '#000000' : 'white', borderRadius: '50%', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center' }}>
              ...
              <div style={{ background: D ? '#000000' : '#f9fafb', border: D ? '0.5px solid #000000' : '0.5px solid #e5e7eb', borderRadius: 11, overflow: 'hidden' }}>
                {pieData.map((d, i) => (
                  <div key={i} style={{ ...S.legendRow, borderBottom: i < pieData.length - 1 ? (D ? '0.5px solid #000000' : '0.5px solid #e5e7eb') : 'none' }}>
