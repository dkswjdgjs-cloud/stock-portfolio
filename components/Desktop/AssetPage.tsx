      ...
      <main style={{ height: "100%", overflowY: "auto", padding: "20px 28px 40px", boxSizing: "border-box" }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 20, alignItems: "start" }}>
          ...
          <div style={{ display: "flex", flexDirection: "column" }}>
            ...
            <div style={{ background: C.card, borderRadius: 16, padding: 22, flex: 1, height: 383, boxSizing: "border-box", display: "flex", flexDirection: "column" }}>
          ...
          <div style={{ display: "flex", flexDirection: "column" }}>
            ...
            <div style={{ background: C.card, borderRadius: 16, padding: "8px 22px 10px", overflowY: "auto", boxSizing: "border-box", height: 383, maxHeight: 383 }}>
              {acctCards.length === 0 ? (
